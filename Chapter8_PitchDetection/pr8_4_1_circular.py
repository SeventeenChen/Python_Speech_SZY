...
if __name__ == '__main__':
	...
	pitch = Pitch()
	period = pitch.CAMDF(yy, fn, voiceseg, vosl, lmax, lmin)
	...
	plt.savefig('images/circular_average_magnitude_difference_pitch_detection.png', bbox_inches='tight', dpi=600)
	plt.show()