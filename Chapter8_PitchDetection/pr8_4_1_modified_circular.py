...
if __name__ == '__main__':
	...
	pitch = Pitch()
	period = pitch.CAMDF_mod(yy, fn, voiceseg, vosl, lmax, lmin)
	...
	plt.subplot(2, 1, 2)
	plt.plot(frameTime, period, 'b', linewidth=2)
	...
	plt.savefig('images/modified_circular_average_magnitude_difference_pitch_detection.png', bbox_inches='tight', dpi=600)
	plt.show()